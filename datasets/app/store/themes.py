...
GROUPS: list[tuple[str, list[tuple[str, str]]]] = [
    ...
    ("KR 방산·조선", [("TIGER K-방산", "449450.KS"), ("KODEX 조선TOP", "494340.KS")]),
    ("KR 인터넷·게임·엔터", [("TIGER 인터넷TOP10", "365000.KS"), ("TIGER K-게임", "300610.KS"),
                    ("KODEX 게임산업", "300950.KS"), ("TIGER 미디어컨텐츠", "228810.KS")]),
    ("KR 금융", [("KODEX 은행", "091170.KS"), ("KODEX 증권", "102970.KS"), ("KODEX 보험", "140700.KS")]),
    ("KR 산업·소재", [("KODEX 건설", "117700.KS"), ("KODEX 철강", "117680.KS"),
               ("KODEX 운송", "140710.KS"), ("KODEX 에너지화학", "117460.KS")]),
    ("KR 소비·화장품", [("KODEX 경기소비재", "266390.KS"), ("KODEX 필수소비재", "266410.KS"),
                 ("TIGER 화장품", "228790.KS")]),
    ("KR 리츠·인프라", [("TIGER 리츠부동산인프라", "329200.KS"), ("KODEX 글로벌인프라", "269420.KS")]),
    ("KR 로봇·메타버스", [("KODEX K-로봇액티브", "445290.KS"), ("KODEX K-메타버스액티브", "401470.KS")]),
    ("KR 고배당·배당성장", [("KODEX 고배당", "279530.KS"), ("TIGER 코스피고배당", "210780.KS"),
                   ("ARIRANG 고배당주", "161510.KS"), ("TIGER 배당성장", "211560.KS")]),
