...
>
> **Test totals (current): 167 unit** — datasets 67 · control-plane 12 · mcp 9 · rag 14 (+2 oss-cpu
> semantic) · agent-engine 33 · studio-api 30 — plus the web build, three docker e2e harnesses
