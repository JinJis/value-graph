...
>
> **Test totals (current): 304 unit** — datasets 121 · control-plane 13 · mcp 9 · rag 17 (+2 oss-cpu
> semantic) · agent-engine 103 · studio-api 38 (+ admin 18, renderer 4) — plus the web build, four docker harnesses
